...
def mountain_car_basic():
    environment = dict(gym_id="MountainCarContinuous-modifed-v0", num_vec=4)
...
@train_adversarial_ex.named_config
def cartpole_basic():
    environment = dict(gym_id="CartPole-modifed-v1", num_vec=4)
    total_timesteps = int(1e5)
...
@train_adversarial_ex.named_config
def highway_basic():
    environment = dict(gym_id="highway-ME-basic-v0", num_vec=4)
...
@train_adversarial_ex.named_config
def parking_basic():
    environment = dict(gym_id="parking-basic-v0", num_vec=8)
