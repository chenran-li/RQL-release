...
class ExperimentManager:
    ...
    def __init__(
        ...
        # Residual Q-learning prior model path
    ...
    def setup_experiment(self) -> Optional[Tuple[BaseAlgorithm, Dict[str, Any]]]:
        ...
        # add prior model path to hyperparams
        if self.algo == "dqn_soft_residual" or self.algo == "sac_residual":
            hyperparams["prior_model_path"] = self.prior_model_path
