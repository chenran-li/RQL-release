...
class HighwayEnvMEBasic(HighwayEnv):
    """
    A variant of highway-v0 with faster execution:
        - lower simulation frequency
        - fewer vehicles in the scene (and fewer lanes, shorter episode duration)
...
class HighwayEnvMEAddRightRewardALL(HighwayEnv):
    """
    A variant of highway-v0 with faster execution:
        - lower simulation frequency
        - fewer vehicles in the scene (and fewer lanes, shorter episode duration)
...
class HighwayEnvMEAddRightReward(HighwayEnv):
    """
    A variant of highway-v0 with faster execution:
        - lower simulation frequency
        - fewer vehicles in the scene (and fewer lanes, shorter episode duration)
...
class HighwayEnvMELagerSpeedRewardALL(HighwayEnv):
    """
    A variant of highway-v0 with faster execution:
        - lower simulation frequency
        - fewer vehicles in the scene (and fewer lanes, shorter episode duration)
...
class HighwayEnvMELagerSpeedReward(HighwayEnv):
    """
    A variant of highway-v0 with faster execution:
        - lower simulation frequency
        - fewer vehicles in the scene (and fewer lanes, shorter episode duration)
...
class HighwayEnvMENone(HighwayEnv):
    """
    A variant of highway-v0 with faster execution:
        - lower simulation frequency
        - fewer vehicles in the scene (and fewer lanes, shorter episode duration)
...
register(
    id='highway-ME-basic-v0',
    entry_point='highway_env.envs:HighwayEnvMEBasic',
)

register(
    id='highway-ME-basic-AddRightRewardALL-v0',
    entry_point='highway_env.envs:HighwayEnvMEAddRightRewardALL',
)

register(
    id='highway-ME-basic-AddRightReward-v0',
    entry_point='highway_env.envs:HighwayEnvMEAddRightReward',
)

register(
    id='highway-ME-basic-LagerSpeedRewardALL-v0',
    entry_point='highway_env.envs:HighwayEnvMELagerSpeedRewardALL',
)

register(
    id='highway-ME-basic-LagerSpeedReward-v0',
    entry_point='highway_env.envs:HighwayEnvMELagerSpeedReward',
)

register(
    id='highway-ME-none-v0',
    entry_point='highway_env.envs:HighwayEnvMENone',
)