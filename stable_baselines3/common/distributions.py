...
class Distribution(ABC):
    ...
    def log_prob_from_params(self, *args, **kwargs) -> Tuple[th.Tensor, th.Tensor]:
        ...
        """
    @abstractmethod
    def log_prob_from_params_given_action(self, *args, **kwargs) -> Tuple[th.Tensor, th.Tensor]:
        """
        Returns the associated log probabilities
        from the probability distribution given its parameters.
...
class DiagGaussianDistribution(Distribution):
    ...
    def log_prob_from_params_given_action(self, mean_actions: th.Tensor, log_std: th.Tensor, actions: th.Tensor) -> Tuple[th.Tensor]:
        self.actions_from_params(mean_actions, log_std)
        log_prob = self.log_prob(actions)
        return log_prob
...
class CategoricalDistribution(Distribution):
    ...
    def log_prob_from_params_given_action(self, action_logits: th.Tensor, actions: th.Tensor) -> Tuple[th.Tensor]:
        self.actions_from_params(action_logits)
        log_prob = self.log_prob(actions)
        return log_prob
...
class StateDependentNoiseDistribution(Distribution):
    ...
    def log_prob_from_params_given_action(self, mean_actions: th.Tensor, log_std: th.Tensor, actions: th.Tensor, latent_sde: th.Tensor) -> Tuple[th.Tensor]:
        self.actions_from_params(mean_actions, log_std, latent_sde)
        log_prob = self.log_prob(actions)
        return log_prob
