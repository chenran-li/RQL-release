...
from stable_baselines3.dqn_soft_residual.policies import ResidualSoftDQNPolicy, ResidualSoftMlpPolicy, ResidualSoftCnnPolicy, ResidualSoftMultiInputPolicy
